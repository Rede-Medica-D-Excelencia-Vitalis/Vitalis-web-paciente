...
describe('TELE-003 - Controles de Microfone', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    localStorage.clear()
  ...
  it('deve ter microfone ligado por padrão', async () => {
    // Mock do consultaService
  ...
  it('deve alternar estado do microfone ao clicar no botão', async () => {
    // Mock do consultaService
    const { consultaService } = await import('../../../services/consultation/consultaService')
    vi.mocked(consultaService.getProximasConsultas).mockResolvedValue([
      {
  ...
  it('deve exibir áudio local quando microfone está ligado', async () => {
    // Mock do consultaService
    const { consultaService } = await import('../../../services/consultation/consultaService')
    vi.mocked(consultaService.getProximasConsultas).mockResolvedValue([
      {
  ...
  it('deve parar áudio local quando microfone está desligado', async () => {
    // Mock do consultaService
    const { consultaService } = await import('../../../services/consultation/consultaService')
    vi.mocked(consultaService.getProximasConsultas).mockResolvedValue([
      {
  ...
  it('deve exibir ícone de microfone desligado quando desabilitado', async () => {
    // Mock do consultaService
    const { consultaService } = await import('../../../services/consultation/consultaService')
    vi.mocked(consultaService.getProximasConsultas).mockResolvedValue([
      {
  ...
  it('deve exibir indicador visual de status do microfone', async () => {
    // Mock do consultaService
    const { consultaService } = await import('../../../services/consultation/consultaService')
    vi.mocked(consultaService.getProximasConsultas).mockResolvedValue([
      {
  ...
  it('deve manter estado do microfone durante a sessão', async () => {
    // Mock do consultaService
    const { consultaService } = await import('../../../services/consultation/consultaService')
    vi.mocked(consultaService.getProximasConsultas).mockResolvedValue([
      {
  ...
  it('deve exibir feedback visual claro do status do microfone', async () => {
    // Mock do consultaService
    const { consultaService } = await import('../../../services/consultation/consultaService')
    vi.mocked(consultaService.getProximasConsultas).mockResolvedValue([
      {
